...
router.get('/',function(req,res){
	db.query("SELECT * FROM ballsExterns ORDER BY numero").then(function(result){
...
router.get('/paginacio/:numero',function(req,res){
	...
	db.query("SELECT * FROM ballsExterns where numero>=$1 AND numero<$2 ORDER BY numero",[numero,numerofi]).then(function(result){
        res.send(result.rows)
    }).catch(function(err){
		console.log(err);
	})
